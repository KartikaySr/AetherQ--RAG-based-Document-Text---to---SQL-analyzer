  ...
  return (
    <div className="fixed inset-0 z-[100] flex items-center justify-center bg-black/80 backdrop-blur-md px-4 py-6">
      ...
      >
        ...
        <div className="p-6">
          <div className="flex items-center justify-between p-4 rounded-2xl border border-white/10 bg-white/[0.02] hover:bg-white/[0.04] transition group">
            <div className="flex items-center gap-4">
              <div className="w-12 h-12 rounded-xl bg-white/5 flex items-center justify-center border border-white/10 group-hover:border-blue-500/50 transition">
                <MessageSquare className="text-white" size={24} />
              </div>
              <div>
                <h3 className="text-white font-semibold">Slack Copilot</h3>
                <p className="text-xs text-white/50">Query AetherQ directly from Slack</p>
              </div>
            </div>
          ...
          <div className="mt-4 flex items-center justify-between p-4 rounded-2xl border border-white/5 bg-white/[0.01] opacity-50 cursor-not-allowed">
            <div className="flex items-center gap-4">
              ...
              <div>
                ...
                <p className="text-xs text-white/50">Enterprise rollout pending</p>
              </div>
            </div>
            <button disabled className="px-4 py-2 rounded-xl bg-white/10 text-white/50 text-sm font-medium">
              Coming Q4
            </button>
          </div>
        </div>
